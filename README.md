 ...
 * Building real products (Telegram, SaaS)
 * Interested in AI integration, backend systems, and full-stack development  
 * Currently focused on:
   - Computer Engineering fundamentals  
   - AI pipelines & API integrations  
   - Cloud & deployment (Vercel, Render, Google Cloud)
 * Fun fact: I start many projects, but I’m intentionally learning to ship fewer, more polished ones  
 * Christian — my faith shapes how I approach work, discipline, and purpose
 * I’m most interested in real-world machine learning problems, especially applying Deep learning algorithms to solve problems many students face. 
...
## 🌐 Socials:
[![LinkedIn
](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://linkedin.com/in/abenezer-mergia) [![X](https://img.shields.io/badge/X-black.svg?logo=X&logoColor=white)](https://x.com/abenii__) 

# 💻 Tech Stack:
<div align="center">
  <img src="https://skillicons.dev/icons?i=python,nextjs,linux,nodejs,react,git,vercel,render,netlify,ps,supabase,&theme=dark&perline=7" alt="Tech stack icons" />
</div>
...
[![LinkedIn](https://skillicons.dev/icons?i=linkedin,&theme=dark&perline=7)](https://linkedin.com/in/abenezer-mergia) 
[![X]( https://skillicons.dev/icons?i=twitter,&theme=dark&perline=7)](https://x.com/abenii__) 
---
